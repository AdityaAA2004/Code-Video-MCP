...
- **Model calls use the server's API key**, not host sampling — FastMCP 4.0.0b3 exposes no `Context.sample()` ([ADR-0003](docs/adr/0003-api-key-primary-host-sampling-fallback.md)).
